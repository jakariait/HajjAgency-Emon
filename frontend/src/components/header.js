...
//
//   return (
//     <nav className="relative border-b-2 border-amber-400/30 px-4 sticky top-0 z-50 bg-white shadow-md overflow-hidden">
...
//               <circle cx="30" cy="30" r="10" fill="none" stroke="#059669" strokeWidth="0.3"/>
//             </pattern>
//           </defs>
...
//             <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
//               <defs>
//                 <pattern id="drawer-pattern" x="0" y="0" width="80" height="80" patternUnits="userSpaceOnUse">
//                   <path d="M40 0 L60 20 L40 40 L20 20 Z M40 40 L60 60 L40 80 L20 60 Z"
//                         fill="none" stroke="#059669" strokeWidth="0.5"/>
//                   <circle cx="40" cy="40" r="15" fill="none" stroke="#059669" strokeWidth="0.3"/>
//                 </pattern>
//               </defs>
            ...
            <div key={idx} className="relative z-50">
              {item.subItems ? (
                ...
                >
                  ...
                  {/* Desktop Submenu with Islamic styling */}
                  <div
                    className={`absolute top-full left-0 bg-white rounded-xl shadow-xl border-2 border-emerald-200/50 transition-all duration-300 transform overflow-visible z-[100] ${
                      openMenuIndex === idx
                        ? "opacity-100 visible translate-y-0"
